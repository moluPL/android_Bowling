...
public class Create_league extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.creating_league);
		init();
	}
	public void init(){
		pattR_id="1";
		pattL_id="1";
		name = (EditText) findViewById(R.id.create_league_text_name);
		home = (EditText) findViewById(R.id.create_league_text_home);
		txt_select_patt = (TextView) findViewById(R.id.create_league_patternselectTXT);
		btn_patterns = (Button) findViewById(R.id.create_league_btn_select_pattern);
		txt_select_patt2 = (TextView) findViewById(R.id.create_league_patternselectTXT2);
		btn_patterns2 = (Button) findViewById(R.id.create_league_btn_select_pattern2);
		btn_save = (Button) findViewById(R.id.create_league_button_save);
		btn_cancel  = (Button) findViewById(R.id.create_league_button_cancel); 
		check = (CheckBox) findViewById(R.id.create_league_checkBoxUnknow);
		checkSame = (CheckBox) findViewById(R.id.create_league_checkSame);
		...
		btn_save.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				if(getValue())
				{
					...
					if(!check.isChecked()){
						if(databaseLeague.addLeague(vname, vhome, pattR_id,pattL_id)){
							setResult(1);
						...
						if(databaseLeague.addLeague(vname, vhome,unknownPatt,unknownPatt)){
							setResult(1);
							Toast.makeText(getApplicationContext(), "Added to Database",Toast.LENGTH_LONG).show();
							finish();
						}
